...
class Renderer {
public:
    explicit Renderer(Position& position, Renderable render_type = Renderable::DIFFICULTY_DIALOGUE)
        : board(position), to_render(render_type) {}
    ...
    void render_difficulty_dialogue();                          // Ask the user what difficulty they want to play on
...
private:
    ...
    void print_foundations_and_drawn_deck();                    // Print foundations, top deck card and drawn stack
